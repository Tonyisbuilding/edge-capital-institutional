...
export function StressTest2022() {
    ...
    //   Instead of CSS scale, we animate the container's actual
    //   left + width so ResponsiveContainer redraws the chart
    //   at the new size (text stays crisp, no stretching)
    // ═══════════════════════════════════════════════════════════

    // left: starts at 42% (right column), centers at 21%, then fills at 0%
    ...
    // width: starts at 56% (grid 60% column minus gap), then fills 100%
    ...
    // height: percentage of viewport height, grows during zoom
    // Starts at 50vh, ends at 75vh (matching NAV chart proportions)
    ...
    // Font size: scales up during zoom for readability
    // Chart texts use em units so they inherit this
    ...
    // ═══════════════════════════════════════════════════════════
    // Phase 3 (0.7 → 1.0): Hold at full size, then release
    // ═══════════════════════════════════════════════════════════

    return (
        // Outer scroll spacer — 200vh of scroll distance for animation
